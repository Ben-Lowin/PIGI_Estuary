...
load Optode_mini_data_PL03.mat
...
% xlim([0 6])
% xticklabels({'', '12/09', '12/10', '12/11','12/12',''});
...
bottle.sample_dates(1) = datetime(2024,12,9,8,59,00,00);
bottle.sample_dates(2) = datetime(2024,12,9,14,54,00,00);
bottle.sample_dates(3) = datetime(2024,12,10,10,8,00,00);
bottle.sample_dates(4) = datetime(2024,12,10,15,55,00,00);
bottle.sample_dates(5) = datetime(2024,12,11,11,13,00,00);
bottle.sample_dates(6) = datetime(2024,12,11,16,56,00,00);
bottle.sample_dates(7) = datetime(2024,12,12,12,14,00,00);
bottle.sample_dates(8) = datetime(2024,12,12,17,56,00,00);
...
figure
plot(1:8, NCP_avr,'*')
errorbar(1:8,NCP_avr,NCP_std,NCP_std,'*')
hold on
errorbar(1:8,bottle.all_NCP,bottle.all_NCP_std,bottle.all_NCP_std,'*')
xlim([0 9])
...
% save('NCP_bottle_data_PL03','bottle')
