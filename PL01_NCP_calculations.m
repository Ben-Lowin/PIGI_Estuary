...
load PL_01_deployment_PIGI_RAW_v20241125.mat
...
%% Define saves and name
%give the name
% dep_info.name = 'PL01_deployment';
% %give a figure output
...
% Looks good
tide_time = water_height.time - hours(3.916);

mld=interp1(tide_time,PL_water_depth,pigi_dat.datetime)';
...
pigi_wind = interp1 (date_w,ws,pigi_dat.datetime)';
