...
% text(4.45815*10^-5, 7, '6.14 hours')
% text(2.20669*10^-5, .8, '12.58 hours')
text(1.15589*10^-5, 29000, '24.03 hours')
text(2.31177*10^-5, 6500, '12.01 hours')



% Note that the M2 tide has a period of approximately 12.42 hours
peak_1 = 1/(4.51847*10^-5)/3600;
peak_2 = 1/(2.20669*10^-5)/3600;
peak_3 = 1/(1.15589*10^-5)/3600;
peak_4 = 1/(2.31177*10^-5)/3600;
