...
% Directory where data are saved
    data_dir = 'C:\Users\BenL\Documents\MATLAB\PIGI\Dock_NCP_02\PIGI_deployment_data';
        
% Directory where output/processed data will be saved
    save_dir = 'C:\Users\BenL\Documents\MATLAB\PIGI\Dock_NCP_02\PIGI_out';
    
% Directory where output/processing data will be saved
    fig_dir = 'C:\Users\BenL\Documents\MATLAB\PIGI\Dock_NCP_02\PIGI_out';

% (Useful) Deployment information
    %REQUIRED:
    dep_info.name = 'PL_02_deployment'; %NOTE - do not use dashes in the name
    dep_info.year = 2024;
    dep_info.start = datestr(datenum(2024,09,15)); %datestring format (e.g. = datestr(datenum(2020,06,01));)
    dep_info.finish = datestr(datenum(2024,09,26)); %datestring format
    %OPTIONAL
    dep_info.id = 'PL02';
...
%remove spike in salinity
 bad_data_2 = find(pigi_dat.time >7.395145561104849e+05 & ...
     pigi_dat.time <7.395145599556322e+05);

pigi_dat.ts_cor.o2uM(bad_data_2)=nan;
pigi_dat.ts_cor.o2sat(bad_data_2)=nan;
pigi_dat.ts_cor.po2(bad_data_2)=nan;
pigi_dat.ts_cor.o2sat(bad_data_2)=nan;
pigi_dat.raw.tp(bad_data_2)=nan;
pigi_dat.raw.tp_fix(bad_data_2)=nan;
pigi_dat.ts_cor.sal(bad_data_2)=nan;
pigi_dat.ts_cor.temp(bad_data_2)=nan;
